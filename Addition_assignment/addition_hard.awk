...
}
{
  ...
  if(length(number_arr)>length(addition_arr))
  {
    for(o=1; o<=length(addition_arr);o++)
    {
      temp[o]=addition_arr[o]
    }
    delete addition_arr
    for(o=1; o<=length(number_arr);o++)
    {
      addition_arr[o]=number_arr[o]
    }
    delete number_arr
    for(o=1; o<=length(temp);o++)
    {
      number_arr[o]=temp[o]
    }
  }
