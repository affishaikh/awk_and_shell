...
END{
  binary_of_plain_text_letters_str="12,102,112,1002,1012,1102,1112,10002,10012,10102,10112,11002,11012,11102,11112,100002,100012,100102,100112,101002,101012,101102,101112,110002,110012,110102"
  split(binary_of_plain_text_letters_str,binary_of_plain_text_letters,",")
  cipher_text_data=toupper(cipher_text_data)
  for(i=1;i<=26;i++)
  {
    gsub(plain_text_letters[i],binary_of_plain_text_letters[i],cipher_text_data)
  }
